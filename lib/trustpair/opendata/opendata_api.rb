  ...
  module Opendata
    ...
    class OpendataApi
      ...
      def initialize (logger = Logger.new(STDOUT))
        @host = Trustpair::Config::CONFIG['api']['opendatasoftware']['host']
        @port = Trustpair::Config::CONFIG['api']['opendatasoftware']['port']
        @sirene_resource = Trustpair::Config::CONFIG['api']['opendatasoftware']['sirene_resource']
        @log = logger
      end
